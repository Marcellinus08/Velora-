  ...
  return (
    <div className="flex h-full grow flex-row">
      ...
      <main className="flex-1 px-4 py-6 sm:px-6 lg:px-8 relative overflow-hidden xl:ml-64
        ...
        md:pb-20 lg:pb-20 xl:pb-6">
        {/* Background decorative elements */}
        <div className="fixed inset-0 overflow-hidden opacity-5 pointer-events-none max-sm:hidden">
          <div className="absolute -top-10 -right-10 w-40 h-40 md:w-32 md:h-32 lg:w-36 lg:h-36 bg-purple-500 rounded-full blur-3xl animate-pulse" style={{ animationDuration: '4s' }} />
          <div className="absolute top-1/3 -left-20 w-32 h-32 md:w-24 md:h-24 lg:w-28 lg:h-28 bg-blue-500 rounded-full blur-2xl animate-pulse" style={{ animationDelay: '2s', animationDuration: '5s' }} />
          <div className="absolute bottom-1/4 right-1/4 w-24 h-24 md:w-20 md:h-20 lg:w-22 lg:h-22 bg-pink-500 rounded-full blur-xl animate-pulse" style={{ animationDelay: '1s', animationDuration: '3s' }} />
        </div>

        {/* Hero Carousel Section */}
        <div 
          ref={carouselRef}
          className="relative mb-8 w-full max-sm:mb-4 md:mb-6 lg:mb-7"
        >
        ...
        <div className="relative mb-8 max-sm:mb-4 md:mb-6 lg:mb-7">
        ...
        <div className="relative max-sm:mb-4 md:mb-5 lg:mb-6">
