...
export default function Home() {
  ...
  return (
    <div className="flex h-full grow flex-row">
      <Sidebar />
      <main className="flex-1 px-3 py-4 sm:px-4 sm:py-6 lg:px-8 relative overflow-hidden pb-20 md:pb-6">
        ...
        <div 
          ref={carouselRef}
          className="relative mb-3 sm:mb-4 lg:mb-6 w-full"
        >
          ...
          <Carousel size="h-[240px] sm:h-[340px] md:h-[400px] lg:h-[480px]" campaignId={campaignId || undefined} />
        </div>
        ...
        <div className="hidden md:block fixed bottom-8 right-8 opacity-20 hover:opacity-100 transition-opacity duration-300 pointer-events-none hover:pointer-events-auto">
