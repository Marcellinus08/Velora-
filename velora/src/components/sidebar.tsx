...
export default function Sidebar() {
  ...
  const mobileBase = "flex flex-col items-center justify-center gap-1 py-2 px-3 text-xs font-medium transition-all duration-200 cursor-pointer min-w-[60px]";
  ...
  return (
    <>
      ...
      <nav className="fixed bottom-0 left-0 right-0 z-50 md:hidden bg-neutral-900 border-t border-neutral-800 safe-area-pb">
