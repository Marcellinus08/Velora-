...
function RecommendationItem({ video }: { video: RecommendedVideo }) {
  return (
    <a href={`/task?id=${video.id}`} className="flex items-start gap-3 rounded-lg p-2 hover:bg-neutral-800/70">
...
export default function RecommendationPanel({ items }: { items: RecommendedVideo[] }) {
  ...
  return (
    <div>
      <h3 className="mb-2 px-2 text-base font-semibold text-neutral-200">Rekomendasi untuk Anda</h3>
