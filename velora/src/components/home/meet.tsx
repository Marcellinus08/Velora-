...
function LoadingSkeletonRow() {
  return (
    <section className="mb-5">
      ...
      >
        {/* Title skeleton - no slide animation */}
        <div className="animate-pulse min-w-[200px] rounded-xl border border-neutral-800 bg-neutral-900 px-3 py-2" style={{ animation: 'none' }}>
