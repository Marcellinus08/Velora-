...
export default function HomeMeetRibbon() {
  ...
  return (
    <section className="mb-3 sm:mb-4">
      <div
        className="mt-2 sm:mt-3 md:mt-4 flex gap-2 sm:gap-2.5 md:gap-3 overflow-x-auto scroll-smooth pl-0 pr-0
                   [-ms-overflow-style:none] [scrollbar-width:none] [&::-webkit-scrollbar]:hidden"
      >
        {/* Title-as-card (tanpa neon) */}
        <Link href="/meet" className="group min-w-[140px] sm:min-w-[160px] md:min-w-[200px] rounded-lg sm:rounded-xl border border-neutral-800 bg-neutral-900 px-2 sm:px-2.5 md:px-3 py-2 text-neutral-300 transition-all duration-300 flex flex-col justify-between flex-shrink-0">
          <div>
          ...
          <div className="mt-1.5 sm:mt-2 w-fit rounded-md border border-neutral-700/70 px-1.5 sm:px-2 py-0.5 sm:py-1 text-[9px] sm:text-[10px] md:text-[11px] font-medium text-[var(--primary-500)] hover:opacity-90 transition-opacity">
            View all →
          </div>
        </Link>

        {/* Coming Soon Banner - Creative Design */}
        <div className="group flex-1 min-w-[240px] sm:min-w-[280px] md:min-w-0 rounded-lg sm:rounded-xl border border-transparent bg-gradient-to-r from-purple-950/80 via-blue-950/60 to-purple-950/80 px-2.5 sm:px-3 md:px-4 py-2 text-neutral-300 transition-all duration-300 flex items-center justify-center hover:shadow-2xl hover:shadow-purple-500/40 relative overflow-hidden">
          ...
          {/* Top light rays */}
          <div className="absolute top-0 left-1/4 w-20 sm:w-24 md:w-32 h-20 sm:h-24 md:h-32 bg-gradient-to-b from-purple-500/40 to-transparent rounded-full blur-3xl -translate-y-1/2 group-hover:from-purple-500/60 transition-all duration-500" />
          <div className="absolute top-0 right-1/4 w-20 sm:w-24 md:w-32 h-20 sm:h-24 md:h-32 bg-gradient-to-b from-blue-500/40 to-transparent rounded-full blur-3xl -translate-y-1/2 group-hover:from-blue-500/60 transition-all duration-500" />
          
          {/* Bottom glow */}
          <div className="absolute bottom-0 left-1/2 -translate-x-1/2 w-32 sm:w-36 md:w-48 h-16 sm:h-20 md:h-24 bg-gradient-to-t from-purple-500/20 to-transparent rounded-full blur-3xl group-hover:from-purple-500/40 transition-all duration-500" />
          ...
          <div className="relative z-10 flex items-center gap-1.5 sm:gap-2 md:gap-4 w-full">
            ...
            <div className="relative flex-shrink-0">
              ...
              {/* Main icon */}
              <div className="relative bg-gradient-to-br from-purple-600 to-blue-600 rounded-lg px-2.5 sm:px-3 md:px-4 py-1.5 sm:py-1.5 md:py-2 shadow-xl shadow-purple-500/50 group-hover:shadow-2xl group-hover:shadow-purple-400/70 transition-all duration-300">
                <span className="material-icons-round text-white text-lg sm:text-xl md:text-2xl leading-none block">videocam</span>
              </div>
            </div>
            ...
            <div className="flex-1">
              ...
              <div className="text-[9px] sm:text-[10px] md:text-[11px] text-purple-200/80 group-hover:text-purple-100 transition-colors duration-300 font-semibold tracking-wide">
                🌟 Meet feature launching soon
              </div>
            </div>
            
            {/* Floating particles */}
            <div className="absolute top-1 sm:top-1.5 md:top-2 right-1.5 sm:right-2 md:right-4 text-sm sm:text-base md:text-xl opacity-60 group-hover:opacity-100 transition-opacity duration-300 animate-bounce" style={{ animationDelay: '0s' }}>✨</div>
            <div className="absolute bottom-1 sm:bottom-1.5 md:bottom-2 right-3 sm:right-4 md:right-8 text-xs sm:text-sm md:text-lg opacity-40 group-hover:opacity-70 transition-opacity duration-300 animate-bounce" style={{ animationDelay: '0.2s' }}>🚀</div>
          </div>
        </div>
