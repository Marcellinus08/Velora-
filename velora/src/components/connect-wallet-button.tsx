...
//   // Hindari hydration mismatch: tunggu sampai mounted
...
//   // Placeholder stabil saat SSR/awal mount
//   if (!mounted) {
//     return (
//       <button
//         className={cn(
...
//         <AbstractLogo className="h-4 w-4 animate-[spin_1.25s_linear_infinite] [transform-origin:center]" />
//       </button>
//     );
//   }
...
//         )}
//       >
//         <span className="leading-none">{isConnecting ? "Connecting…" : "Sign In"}</span>
//         <AbstractLogo className="h-4 w-4 animate-[spin_1.25s_linear_infinite] motion-reduce:animate-none [transform-origin:center]" />
//       </button>
//     );
//   }

//   // CONNECTED (loading balance)
//   if (isBalanceLoading) {
//     return (
//       <button
//         disabled
...
//         <Button className={cn("min-w-40 px-3", className)}>
...
//         <DropdownMenuItem className="cursor-auto focus:bg-transparent">
...
//   return (
//     <svg width="16" height="16" viewBox="0 0 640 640" xmlns="http://www.w3.org/2000/svg" className={cn(className)}>
//       <path
...
//   return (
//     <svg
//       width="20" height="18" viewBox="0 0 52 47" fill="none"
...
interface ConnectWalletButtonProps {
  className?: ClassValue;
  // Custom dropdown items (array of JSX nodes). If tidak diberikan,
  // ConnectWalletButton akan render default Disconnect item.
  customDropdownItems?: React.ReactNode[];
}
...
export function ConnectWalletButton({ className, customDropdownItems }: ConnectWalletButtonProps) {
  ...
  // Placeholder saat SSR / belum mounted
  if (!mounted) {
    return (
      <button
        className={cn(
  ...
  return (
    <DropdownMenu>
      ...
      <DropdownMenuContent align="center" side="bottom" className="w-72">
        ...
        <div className="px-3 py-2">
          <div className="flex w-full items-center justify-between">
            <div>
              ...
              <div className="mt-1 text-sm font-medium">{/* optional: ENS / name if available */}</div>
            </div>
            ...
            <div className="flex items-center gap-2">
              ...
              <AbstractLogo className="h-5 w-5 opacity-60" />
            </div>
          </div>
        </div>
        ...
        {customDropdownItems ? (
          <div className="py-1">{customDropdownItems.map((it, idx) => <div key={idx}>{it}</div>)}</div>
        ) : (
          <>
            <DropdownMenuSeparator />
            <DropdownMenuItem onClick={logout} className="text-destructive">
