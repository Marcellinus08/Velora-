  ...
  return createPortal(
    <>
      ...
      <div className="fixed inset-0 z-[10001] flex items-center justify-center p-4">
        <div className="bg-neutral-900 rounded-2xl shadow-2xl max-w-md w-full animate-in zoom-in-95 duration-200 border border-neutral-800">
          {/* Icon */}
          ...
          <div className="flex gap-3 px-6 pb-6">
            <button
              onClick={onCancel}
              className="flex-1 px-6 py-3 rounded-xl bg-neutral-800 hover:bg-neutral-700 text-white font-semibold transition-colors duration-200 border border-neutral-700"
            >
              {cancelText}
            </button>
            <button
              onClick={onConfirm}
              className={`flex-1 px-6 py-3 rounded-xl text-white font-semibold transition-colors duration-200 ${style.confirmBg}`}
            >
              {confirmText}
            </button>
          </div>
