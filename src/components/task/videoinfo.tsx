          ...
          <div className="mt-4 flex items-center justify-between rounded-2xl border border-neutral-800 bg-neutral-900/60 p-3 sm:p-4">
            ...
            {!isSelf && (
              ...
              >
                {followBusy ? (
                  <>
                    <svg className="animate-spin max-sm:h-5 max-sm:w-5 sm:h-4 sm:w-4" fill="none" viewBox="0 0 24 24">
                  ...
                  <>
                    <svg className="max-sm:h-5 max-sm:w-5 sm:h-4 sm:w-4" fill="currentColor" viewBox="0 0 20 20">
                  ...
                  <>
                    <svg className="max-sm:h-5 max-sm:w-5 sm:h-4 sm:w-4" fill="none" viewBox="0 0 24 24" stroke="currentColor">
