        ...
        >
          ...
          <div className="flex items-center justify-between p-6 border-b border-neutral-800">
            <div className="flex items-center gap-3">
              ...
              <div>
                <h2 className="text-lg font-bold text-neutral-100">Share Post</h2>
            ...
            <div className="mt-4 p-4 bg-neutral-800/50 rounded-xl border border-neutral-700">
              ...
              <div className="flex items-center gap-2">
                <input
                  ...
                  value={postUrl}
                  readOnly
                  className="flex-1 bg-neutral-900 border border-neutral-700 rounded-lg px-3 py-2 text-sm text-neutral-300 focus:outline-none focus:ring-2 focus:ring-purple-500/50"
                />
                <button
