        ...
        {items.length === 0 ? (
          <div className="p-8 max-sm:p-6 text-center">
            <div className="flex flex-col items-center gap-3 max-sm:gap-2">
              <div className="w-16 h-16 max-sm:w-12 max-sm:h-12 rounded-full bg-gradient-to-br from-blue-600/20 to-purple-600/20 flex items-center justify-center">
              ...
              <p className="text-neutral-400 font-medium max-sm:text-sm">No meets yet.</p>
              <p className="text-sm max-sm:text-xs text-neutral-500">Your completed meet bookings will appear here.</p>
            </div>
          </div>
        ) : (
              ...
              return (
                ...
                >
                  ...
                  <div className="relative flex items-center gap-4 max-sm:gap-3 max-sm:flex-col">
                    {/* Participant Avatar */}
                    <div className="relative w-16 h-16 max-sm:w-20 max-sm:h-20 max-sm:mx-auto flex-shrink-0 rounded-full overflow-hidden bg-neutral-800/50 border-2 border-neutral-700/50 group-hover:border-blue-500/50 transition-all duration-200 group-hover:shadow-lg group-hover:shadow-blue-900/20">
                      {meet.participant_avatar ? (
                        ...
                        <div className="w-full h-full flex items-center justify-center bg-gradient-to-br from-blue-600/20 to-purple-600/20">
                          <svg className="w-8 h-8 max-sm:w-10 max-sm:h-10 text-neutral-500" fill="currentColor" viewBox="0 0 20 20">
                            <path fillRule="evenodd" d="M10 9a3 3 0 100-6 3 3 0 000 6zm-7 9a7 7 0 1114 0H3z" clipRule="evenodd" />
                          </svg>
                        </div>
                      )}
                      
                      {/* Status badge on avatar for mobile */}
                    ...
                    <div className="flex-1 min-w-0 max-sm:w-full max-sm:text-center">
                      ...
                      {/* Meet Details */}
                      <div className="flex flex-wrap items-center gap-x-3 gap-y-1 mt-1.5 text-xs max-sm:text-[10px] text-neutral-500 max-sm:justify-center">
                        <div className="flex items-center gap-1">
                          ...
                          <span className="max-sm:hidden">{formatDateTime(meet.scheduled_at)}</span>
                          <span className="sm:hidden">{formatDate(meet.scheduled_at)}</span>
                        </div>
                        ...
                        <span className="max-sm:hidden">Booked {timeAgo(meet.created_at)}</span>
                      </div>
                    </div>
                    ...
                    <div className="flex-shrink-0 flex items-center gap-4 max-sm:gap-2 max-sm:w-full max-sm:justify-between">
                      ...
                      <div className="flex items-center gap-2 max-sm:gap-1.5 bg-neutral-800/50 rounded-lg px-3 py-2 max-sm:px-2 max-sm:py-1.5 border border-neutral-700/50 max-sm:flex-1">
                        <div className="text-center max-sm:flex max-sm:items-center max-sm:gap-1.5 max-sm:w-full max-sm:justify-between">
                          <p className="text-[9px] max-sm:text-[8px] text-neutral-500 font-semibold uppercase tracking-wider">Earnings</p>
                          <p className="text-lg max-sm:text-base font-bold bg-gradient-to-br from-emerald-400 to-green-400 bg-clip-text text-transparent mt-0.5 max-sm:mt-0">
